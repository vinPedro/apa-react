...
export default function ProfissionalCadastroForm() {
    ...
    const [alert, setAlert] = useState(null); // Estado unificado
            ...
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="ufConselho" value={formData.ufConselho} onChange={handleChange} required maxLength="2" placeholder="Ex: SP, MG" className="uppercase w-full p-3 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" disabled={isLoading} />
                    </div>
                    ...
                    <div>
                        ...
                        <input type="password" name="senha" value={formData.senha} onChange={handleChange} required minLength="8" placeholder="Mínimo 8 caracteres" className="w-full p-3 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" disabled={isLoading} />
                    </div>
                </div>
